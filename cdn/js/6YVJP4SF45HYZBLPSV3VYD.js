(function () {
  ...
  window.adroll_seg_eid = "6YVJP4SF45HYZBLPSV3VYD";
...
rtb.innerHTML = ["/cm/bombora/out?advertisable=KCCYAWFITRFXJGVIGDZJNY","/cm/experian/out?advertisable=KCCYAWFITRFXJGVIGDZJNY"].reduce(function (acc, cmURL) {
...
__adroll._head().appendChild(rtb);
  ...
  if (typeof __adroll.set_pixel_cookie != 'undefined') {__adroll.set_pixel_cookie(adroll_adv_id, adroll_pix_id, "6YVJP4SF45HYZBLPSV3VYD");}
}());
